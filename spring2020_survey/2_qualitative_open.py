...
for school in schools:
    ...
    for question in questions.itertuples():
        ...
        responses = df_school[question.Question_ID]
        for row in responses:  # responses is a Series, can loop through normally without itertuples()
            if isnotna(row):  # ignore blank responses
