...
def copyValues(input_sheet, output_sheet, mapping_array):
    ...
    for year in column_with_year:
        ...
        for new_column, old_row, offset in mapping_array:
            ...
            logicalSelectivityYield = (new_column in (10, 16, 23, 11, 17, 24, 37, 38)) and \
                (old_row in (29, 35, 33, 30, 36, 44, 30, 42, 50, 31, 43, 51, 36, 37))
            logicalBlank = (input_value is None) or (input_value == '') or (
                input_value == 'n/a')
